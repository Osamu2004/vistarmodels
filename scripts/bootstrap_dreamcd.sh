...
DREAMCD_CKPT="${DREAMCD_CKPT:-${DREAMCD_WEIGHT_ROOT}/${DREAMCD_WEIGHT_SET}/ldm.ckpt}"
DREAMCD_VQVAE_CKPT="${DREAMCD_VQVAE_CKPT:-${DREAMCD_WEIGHT_ROOT}/${DREAMCD_WEIGHT_SET}/vqvae.ckpt}"
